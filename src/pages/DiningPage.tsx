...
import { getUserData, saveUserData, visitLocation, feedingCaves } from '@/utils/gameUtils';
...
const DiningPage = () => {
  ...
  const handleVisit = (location) => {
    try {
      const result = visitLocation(userData, 'feeding', location.id);
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="max-w-5xl mx-auto">
          <div className="mb-8 text-center">
            <h1 className="font-uncial text-3xl text-medieval-burgundy mb-2">Feeding Zones</h1>
            <p className="text-medieval-brown">Visit our feeding zones to replenish thy strength</p>
          </div>
